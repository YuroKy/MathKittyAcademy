...
- спільний lesson/review/diagnostic renderer зі structured answers, matching, multiple choice і step-by-step;
- повні уроки для 55 тем 1–4 класів, усіх 16 тем 5 класу та перших 7 тем 6 класу;
...
- Dexie schema v4 з дедуплікованими 30-секундними activity pulses;
- налаштування профілю, доступності та versioned JSON backup із валідацією 25 МБ й атомарним відновленням;
...
Наступні 15 тем 6 класу та уроки 7–9 класів додаються окремими контентними хвилями; усі теми вже мають metadata та коротке інтерактивне прев’ю.
